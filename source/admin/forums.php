  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="#"  class="active"><i class="glyphicon glyphicon-list-alt"></i> Forums</a></li>
        <li><a href="#"><i class="glyphicon glyphicon-book"></i> Category</a></li>
        <li><a href="#"><i class="glyphicon glyphicon-briefcase"></i> Actions</a></li>
