  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="users.php" class="active"><i class="glyphicon glyphicon-user"></i> Users</a></li>
                  ...
                  <div class="panel-heading"><h4>Vue globale</h4></div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            // fais une requete qui recupere les commetaires d'un forum
                            $actionsQuery = "SELECT * FROM users";
                            $resultat = mysqli_query($connexion, $actionsQuery);
                            ...
                            ?>
                            <tr>
                            <td><?php echo '<img src="../login/' . $row['avatar'] . '" style="width:50px;" alt="user" class="img-fluid img-thumbnail rounded-circle">';?></td>
                            ...
                            <td style="width: 100px">
                                ...
                                <a href="usersDelete.php?user_id=<?php echo $row['id']?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Tooltip on top" onclick="return confirm('Are you sure?')">
