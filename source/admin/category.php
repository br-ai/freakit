                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 100px">
                                                        ...
                                                        <a href="categoryUpdate.php?category_id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                                                            <span class="fa fa-pencil"></span>
                                                        </a>
                                                        <a href="categoryDelete.php?category_id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Tooltip on top" onclick="return confirm('Are you sure?')">
