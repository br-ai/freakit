            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($result) {
                    ...
                    if ($rowCount == 1) {
                        ...
                        $confirmationLink = "localhost/freakit/source/login/reset_password2.php?code=$verificationCode";
                        $headers = "From: brandonsitedjeya@gmail.com";

                        $message = "Merci de cliquer sur le lien suivant pour renitialiser votre mot de passe  : $confirmationLink";
                        mail($email, "Renitialiser Le mot de passe", $message, $headers);
                        ...
                        echo '<div style="display: block;
                            ...
                            border-radius: 15px;
                            z-index: 9999;
                            text-align: center;">Reussi, veuillez modifier votre mot de passe  en cliquant sur le lien par mail </div>';

                            
                        } else {
                            
                            echo '<div style="display: block; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background-color: #ff0000; color: #fff; border-radius: 15px; z-index: 9999; text-align: center;"> Email introuvale </div>';
                        }
                    } else {
                        echo '<div style="display: block; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background-color: #ff0000; color: #fff; border-radius: 15px; z-index: 9999; text-align: center;"> Email introuvale </div>';
                    }
                    ...
                    $error_message = "Oups, veuillez reesayer";
                    ...
                    <div class="card-body p-0">
                        <div class="row no-gutters">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="mb-4">
                                        <h3 class="h4 font-weight-bold text-theme">Recommencer</h3>
                                        
                                    </div>
                                    <div class="social-title ">Renitialiser votre mot de passe</div>
                                    ...
                                    <form action="reset_password.php" method="post">
                                        <div class="form-group">
                                            <label for="email">Votre Email <span class="required_form">*</span></label>
