                                ...
                                <div class="col-md-6" id="project-items-<?php echo $row['id']; ?>">
                                    ...
                                    <div  onclick="location.href='forumDetails?forum_id=<?php echo $row['id']; ?>'">
                                            ...
                                            <?php
                                                ...
                                                <p class="text-sm"><span class="op-6" style="color: grey;">Crée par</span>  <a class="text-black-underline" href="#"><img src="../login/<?php echo $avatar ?>" alt="" class="rounded-circle avatar-sm"><?php echo $pseudo; ?></a></p>
